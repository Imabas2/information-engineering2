...
int main() {
    ...
    sf::RectangleShape rectangle(sf::Vector2f(120.0, 160.0));
    rectangle.setPosition(500.0, 400.0);
    rectangle.setFillColor(sf::Color(100, 150, 250));
        ...
        while (window.isOpen()) {
            ...
            if(rectangle_bounds.top<=0 || rectangle_bounds.top+rectangle_bounds.height>=window.getSize().y)
            {
                if(flag_y != true)
                {
                    ...
                    rectangle.setFillColor(sf::Color(rand() % 300,
                                                     rand() % 300,
                                                     rand() % 300));
